...
//        LOG.debug("Sending Json Serializer : {}", user);
//        LOG.debug("--------------------------------");
//
...
//                LOG.debug("Success Callback: [{}] delivered with offset -{}", message,
//                        result.getRecordMetadata().offset());
//            }
//
//            @Override
//            public void onFailure(Throwable ex) {
//                LOG.debug("Failure Callback: Unable to deliver message [{}]. {}", message, ex.getMessage());
//            }
//        });
//    }
